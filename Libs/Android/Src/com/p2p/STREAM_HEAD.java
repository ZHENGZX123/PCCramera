...
public class STREAM_HEAD {
	...
	public static final int VIDEO_FRAME_FLAG_I	= 0x00;	// Video I Frame
	public static final int VIDEO_FRAME_FLAG_P	= 0x01;	// Video P Frame
	public static final int VIDEO_FRAME_FLAG_B	= 0x02;	// Video B Frame
	...
	byte nParameter=0;		//Video: refer to SEP2P_ENUM_VIDEO_FRAME.   Audio:(samplerate << 2) | (databits << 1) | (channel)
	byte nLivePlayback=0;	//Video: 0:live video or audio;  1:playback video or audio
