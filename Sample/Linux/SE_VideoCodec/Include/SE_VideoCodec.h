...
extern "C"
{
	...
	SE_VIDEOCODEC_API INT32  SEVideo_YUV420toJPG(unsigned char *inYUV420Planar, unsigned long inLen, unsigned char *outJPG, unsigned long *in_outLen, int videoWidth, int videoHeight);
