...
-(void)show
{
    if(!self.isAnimating)
    {
        ...
        if(self.showFacebookBubble) {
            UIButton *facebookBubble = [self shareButtonWithIcon:@"audio.png" andBackgroundColorRGB:self.facebookBackgroundColorRGB];
        ...
        if(self.showTwitterBubble) {
            UIButton *twitterBubble = [self shareButtonWithIcon:@"micro_on.png" andBackgroundColorRGB:self.twitterBackgroundColorRGB];
        ...
        if(self.showGooglePlusBubble) {
            UIButton *googlePlusBubble = [self shareButtonWithIcon:@"hori_tour.png" andBackgroundColorRGB:self.googlePlusBackgroundColorRGB];
        ...
        if(self.showTumblrBubble) {
            UIButton *googlePlusBubble = [self shareButtonWithIcon:@"vert_tour.png" andBackgroundColorRGB:self.tumblrBackgroundColorRGB];
        ...
        if(self.showMailBubble) {
            UIButton *mailBubble = [self shareButtonWithIcon:@"record.png" andBackgroundColorRGB:self.mailBackgroundColorRGB];
...
-(UIButton *)shareButtonWithIcon:(NSString *)iconName andBackgroundColorRGB:(int)rgb
{
    ...
    // Circle background
    UIView *circle = [[[UIView alloc] initWithFrame:CGRectMake(0, 0, 2 * self.bubbleRadius, 2 * self.bubbleRadius)] autorelease];
