             ...
             menuItems:(NSArray *)menuItems
{
    ...
    KYLXMenuOverlay *overlay = [[KYLXMenuOverlay alloc] initWithFrame:view.bounds];
        ...
        if (animated) {
            ...
            [UIView animateWithDuration:0.2
                             animations:^(void) {
                                 ...
                                 if ([self.superview isKindOfClass:[KYLXMenuOverlay class]])
...
- (void)performAction:(id)sender
{
    ...
    KYLXMenuItem *menuItem =(KYLXMenuItem *) _menuItems[button.tag];
...
- (UIView *) mkContentView
{
    ...
    UIFont *titleFont = [KYLXMenu titleFont];
    ...
    for (KYLXMenuItem *menuItem in _menuItems) {
    ...
    UIImage *selectedImage = [KYLXMenuView selectedImage:(CGSize){maxItemWidth, maxItemHeight + 2}];
    UIImage *gradientLine = [KYLXMenuView gradientLine: (CGSize){maxItemWidth - kMarginX * 4, 1}];
             ...
             inContext:(CGContextRef) context
{
    ...
    UIColor *tintColor = [KYLXMenu tintColor];
    if (tintColor) {
