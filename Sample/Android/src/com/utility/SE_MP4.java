...
public class SE_MP4 {
	static {
		...
		}catch (UnsatisfiedLinkError ule) { System.out.println("loadLibrary(SE_MP4)," + ule.getMessage()); }
	}
	...
	public native static int SEMP4_Init(String strAndroidPackageName, int nAndroidBuildVersion);
