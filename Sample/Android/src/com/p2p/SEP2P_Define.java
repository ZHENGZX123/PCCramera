...
public class SEP2P_Define {
	...
	public static final int SEP2P_MSG_START_VIDEO 				               = 0x0110; // start video
	public static final int SEP2P_MSG_STOP_VIDEO 				               = 0x0111; // stop video
	public static final int SEP2P_MSG_START_AUDIO 				               = 0x0112; // start audio
	public static final int SEP2P_MSG_STOP_AUDIO 				               = 0x0113; // stop audio
	...
	public static final int SEP2P_MSG_STOP_TALK 				               = 0x0117; // stop talk
