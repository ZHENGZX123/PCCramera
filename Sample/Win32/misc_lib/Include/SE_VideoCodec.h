...
extern "C"
{
	...
	SE_VIDEOCODEC_API UINT32 SEVideo_YUV420toRGB565(UCHAR *pHandle,UCHAR *inYUV420Planar, unsigned long inLen, UCHAR *outRGB565, unsigned long *in_outLen, INT32 videoWidth, INT32 videoHeight);
